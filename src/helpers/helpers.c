...
/**
 * @brief Função Para Ajudar a Escrita
 * Rotina para facilitar a escrita em arquivos.
...
/**
 * @brief Função para Ajudar a Leitura.
 * Rotina para facilitar a leitura de arquivos.
