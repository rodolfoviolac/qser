...
\begin{DoxyCompactList}\small\item\em Main File For Entrance Of The Qser Funcao main responsavel pela criacao das thread do usuario. \end{DoxyCompactList}\end{DoxyCompactItemize}
